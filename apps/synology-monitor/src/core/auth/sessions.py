...
monolith during Phase 4 Slice C, mirroring the unix-monitor ``sessions`` module
boundary. These functions build and validate the HMAC-signed browser cookies
that gate the operator UI:
