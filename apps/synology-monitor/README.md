...
```bash
curl -sL https://raw.githubusercontent.com/EasySystems-GmbH/EasySystems-GmbH/easymonitoring-artefacts/main/apps/synology-monitor/install.sh | env PUBLIC_REPO=EasySystems-GmbH/EasySystems-GmbH/easymonitoring-artefacts bash
```

Or with wget:

```bash
wget -qO- https://raw.githubusercontent.com/EasySystems-GmbH/EasySystems-GmbH/easymonitoring-artefacts/main/apps/synology-monitor/install.sh | env PUBLIC_REPO=EasySystems-GmbH/EasySystems-GmbH/easymonitoring-artefacts bash
```
...
2. URL: `https://raw.githubusercontent.com/EasySystems-GmbH/EasySystems-GmbH/easymonitoring-artefacts/main/apps/synology-monitor/community-package/repo/packages.json`
...
- **Latest release:** `https://github.com/EasySystems-GmbH/EasySystems-GmbH/easymonitoring-artefacts/releases/latest/download/synology-monitor-basic.spk`
- **All releases:** `https://github.com/EasySystems-GmbH/EasySystems-GmbH/easymonitoring-artefacts/releases`
...
6. Select mode (`smart`, `storage`, or `both`), save, then run connection test.
   - Additional monitor modes available in the web UI: `ping`, `port`, `dns`, `backup`, `service`
